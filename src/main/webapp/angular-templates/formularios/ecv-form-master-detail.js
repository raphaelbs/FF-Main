/**
 * [ecvFormMasterDetail]
 * Diretiva representativa do formuário mestre/detalhe.
 * Raphael Brandão - 04/01/2016
 */
angular.module('financeiro').directive('ecvFormMasterDetail', ['$http', '$ecv', '$mdDialog',
	function($http, $ecv, $mdDialog){
	return {
		restrict: 'E',
		templateUrl: GetDOMINIOEndpoint('angular-templates/formularios/ecv-form-master-detail.html'),
		scope: {
			data: '='
		},
